...
// Helper function to handle keyboard events during the scan
//The function, in fact, links between the scan and the keyboard keys, when you press one of the specified keys, we will "handle" one of the options of the scan
